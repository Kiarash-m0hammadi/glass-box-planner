...
1.  **Clone the Repository:**
    ```bash
    git clone [Repository Link Anonymized]
...
This project is structured to ensure that the research is transparent, accessible, and verifiable.
...
*   **Data Access & Citation:** The input dataset for the Qazvin case study is not stored in this repository. It is permanently archived on Zenodo to ensure long-term availability and is licensed under a Creative Commons Attribution 4.0 International license.
    *   **DOI:** `[DOI Anonymized for Peer Review]`
    *   **Citation:** [Anonymized for Peer Review]. (2025). *Qazvin Parcel Dataset for the Glass Box Planner Study* [Data set]. Zenodo. [Link Anonymized for Peer Review]
...
> [Anonymized for Peer Review]. (2026). The Glass Box Planner: From Deductive Policy Audits to a Normative Framework for Urban AI. Forthcoming.
