...
*   **Direct Link:** [Link Anonymized for Peer Review]

If you use this dataset in your research, you are required to cite it. Please use the following formal citation:

> [Anonymized for Peer Review]. (2025). *Qazvin Parcel Dataset for "The Glass Box Planner" Study* (v1.0.0) [Data set]. Zenodo. [Link Anonymized for Peer Review]
